...
import mx.fei.pr.dominio.actores.Jugador;
import mx.fei.pr.interfazgrafica.JugadorPartida;
import mx.fei.pr.interfazgrafica.PrincipalController;
...
public class AdministradorSesionActual {
     ...
     * @throws java.net.URISyntaxException Lanzada al error en conectar el
     * socket
     */
