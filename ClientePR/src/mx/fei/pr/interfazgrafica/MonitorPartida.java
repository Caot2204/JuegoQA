 ...
 */
package mx.fei.pr.interfazgrafica;
...
import mx.fei.pr.partida.GraficaRespuestas;
import mx.fei.pr.partida.MensajeChat;
import mx.fei.pr.partida.Partida;
import mx.fei.pr.partida.PuntajeJugador;
import mx.fei.pr.sesion.AdministradorSesionActual;
import mx.fei.pr.utileria.UtileriaCorreo;
import mx.fei.pr.utileria.UtileriaInterfazUsuario;
...
public class MonitorPartida {
    ...
    private MonitorPartida() throws URISyntaxException, RemoteException {
        ResourceBundle propiedadesCliente = ResourceBundle.getBundle("mx.fei.pr.utileria.cliente");
